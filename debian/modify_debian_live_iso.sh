...
sudo chroot new_root bash -c "DEBIAN_FRONTEND=noninteractive apt-get install -y adb bash-completion chromium espeak-ng fastboot gimp git ibus-pinyin mpv qemu-system-x86 wireshark wodim xorriso obs-studio"
