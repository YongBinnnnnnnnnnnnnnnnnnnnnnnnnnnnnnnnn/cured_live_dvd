...
sudo chroot new_root bash -c "DEBIAN_FRONTEND=noninteractive apt-get install -y bash-completion chromium espeak-ng gimp git ibus-pinyin mpv qemu-system-x86 wireshark wodim xorriso obs-studio"
